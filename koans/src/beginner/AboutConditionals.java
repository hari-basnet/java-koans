...
public class AboutConditionals {
    ...
    public void switchStatementCrazyFallThrough() {
        ...
        assertEquals(result, "Basic NothingTwo"); // be careful if break is applied or not
    }
    ...
    public void shortCircuit() {
        Counter trueCount = new Counter(true);  // counter used here is defined  at the bottom of this page
