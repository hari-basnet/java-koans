...
public class AboutArrays {
    ...
    public void cloneEqualityIsNotRespected() { //!
        ...
        // System.out.println("this is my text: " + original);
    }
    ...
    public void arrayIndexOutOfBounds() {
        int[] array = new int[]{1};
        try{
            // me ---> here this statement is trying to set the second element of the array to
            // meh variable and the second element is not present hence java throws an error which
            // we must catch properly
